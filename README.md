...
This document explains the the process of installing WOVN.io Ruby, as well as setting up preferences parameters.
...
To use the WOVN.io Ruby Library, insert the following line into your Ruby Application's Gemfile. Ensure to use Library Version 0.2 and up.
...
After installing the library, insert into the Ruby Application's setting file the following.

* In you're using Ruby on Rails
