...
module Wovnrb
  class HTMLTextReplacerTest < WovnMiniTest
    ...
    def test_replace_with_complex_value_src_unballanced_alignment
      replacer = HTMLTextReplacer.new({}, {
        'Hello<a>World</a>!' => {'ja' => [{'data' => '<a>こんにちは World!</a>'}]}
      })
    ...
    def test_replace_with_complex_value_dst_unballanced_alignment
      replacer = HTMLTextReplacer.new({}, {
        '<a>Hello World</a>!' => {'ja' => [{'data' => '<a>こんにちは World!</a>'}]}
      })
